...
def main():
    ...
    parser.add_argument("paths", nargs="*", help="Trace JSONL files, directories, or globs. Defaults to AETHER_DEV_DIAGNOSTICS_DIR, METEOR_DEV_DIAGNOSTICS_DIR, or /tmp/aetherxiv-traces.")
