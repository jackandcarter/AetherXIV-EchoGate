...
This page is the quick path for a developer who wants to understand what exists, reproduce a behavior, and make a change without getting lost in the whole AetherXIV codebase.
